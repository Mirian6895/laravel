...
class StudentController extends Controller
{
    ...
    $arrayStudent = ['nombre' => $request->nombre, 'apellido' => $request->apellido, 'email' => $request->email, 'telefono' => $request->telefono, 'sexo' => $request->sexo, 'foto' => $fileName];Student::create($arrayStudent);return response()->json(['status' => 200,]);
    }
    ...
    $arrayStudent = ['nombre' => $request->nombre, 'apellido' => $request->apellido, 'email' => $request->email, 'telefono' => $request->telefono, 'sexo' => $request->sexo, 'foto' => $fileName];$stud->update($arrayStudent);
